...
![1](https://cdn.jsdelivr.net/gh/chenruida/image@master/uPic/1YdxMO7.png)
...
![18](https://cdn.jsdelivr.net/gh/chenruida/image@master/uPic/18PssMw8.png)
...
![19](https://cdn.jsdelivr.net/gh/chenruida/image@master/uPic/19MyWni3.png)
...
![20](https://cdn.jsdelivr.net/gh/chenruida/image@master/uPic/20CsuASu.png)
...
![2](https://cdn.jsdelivr.net/gh/chenruida/image@master/uPic/29xpItg.png)
...
![4](https://cdn.jsdelivr.net/gh/chenruida/image@master/uPic/4S8aHp9.png)
...
![3](https://cdn.jsdelivr.net/gh/chenruida/image@master/uPic/555vLqYya.png)
...
![5](https://cdn.jsdelivr.net/gh/chenruida/image@master/uPic/5OdJbuy.png)

（2）启动服务提供者工程和服务消费者工程，可以在查看到对应的信息

![6](https://cdn.jsdelivr.net/gh/chenruida/image@master/uPic/6gAKwgG.png)

![7](https://cdn.jsdelivr.net/gh/chenruida/image@master/uPic/7oZuDeh.png)

![8](https://cdn.jsdelivr.net/gh/chenruida/image@master/uPic/8f6BI1j.png)

![9](https://cdn.jsdelivr.net/gh/chenruida/image@master/uPic/9NuexR7.png)
...
![12](https://cdn.jsdelivr.net/gh/chenruida/image@master/uPic/12tjVpbP.png)

上面的错误为没有可用的服务提供者

查看dubbo管理控制台发现服务并没有发布，如下：

![13](https://cdn.jsdelivr.net/gh/chenruida/image@master/uPic/13SjAAug.png)



可以通过断点调试的方式查看Dubbo执行过程，Dubbo通过AnnotationBean的postProcessAfterInitialization方法进行处理

![14](https://cdn.jsdelivr.net/gh/chenruida/image@master/uPic/14OSQcLi.png)
